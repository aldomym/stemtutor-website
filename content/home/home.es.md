...
{{< contact-section 
    ...
    contact_form_message="Describe la materia, el tema y el nivel de tu consulta"
    contact_button="Enviar mensaje"
    contact_phone_number="+52 XXX XXX XXXX"
    contact_email_email="aldon2004@hotmail.com"
    contact_address_address="Ciudad de México, México"
    sectionId="contacto"
>}}